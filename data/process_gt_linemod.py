...
def process_occlusion_linemod(linemod_occlusion_path, save_dir):
    ...
    for idx_obj in tqdm(range(len(inout.process_occlusion_real_ids))):
        id_obj = inout.process_occlusion_real_ids[idx_obj]
...
if __name__ == '__main__':
    ...
    for idx, id_obj in enumerate(inout.process_occlusion_real_ids):
